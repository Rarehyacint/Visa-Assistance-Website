...
export default function SignUpForm({ onSwitchMode, onSignUpSuccess }) {
  ...
  return (
    <div className="figma-create-account-card">
      ...
      <form onSubmit={handleSubmit} className="auth-form">
        ...
        <div className="form-group">
          ...
          <div className="figma-input-group">
            <User size={18} className="figma-input-icon" />
            <input
              type="text"
        ...
        <div className="form-group">
          ...
          <div className="figma-input-group">
            <Lock size={18} className="figma-input-icon" />
            <input
        ...
        {/* Social Grid: Google & LinkedIn */}
        <div className="figma-social-grid">
          <button
            type="button"
            className="figma-social-pill-btn"
        ...
        {/* Footer Link */}
        <div className="figma-card-bottom-link">
          <span>Already have an account? </span>
          <button
            type="button"
            className="figma-blue-link"
